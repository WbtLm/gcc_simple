...
//    tool();
    ...
    ret=get_syntax_matrix(*&matrix,"/Users/dawn/f/lan/lan.txt");
    
    if(ret<0){
        return -1;
    }
    ret=get_word(*&word_lst,"/Users/dawn/f/lan/input.c");
    if(ret<0){
        return -1;
    }
...
//    }
    ...
    {
        FILE *out_fp = fopen("/Users/dawn/f/lan/mid.c", "wt");
        if(out_fp==NULL){
